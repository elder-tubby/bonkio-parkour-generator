...
1. Install this [bonk.io mod]([https://github.com/elder-tubby/bonkio-parkour-generator/blob/main/browser-script/pkrGenerator.js](https://github.com/elder-tubby/bonkio-parkour-generator/blob/ae713f9d40394e62816f0e57d771a7bf852e413d/browser-script/pkrGenerator.js)) on a script manager like tampermonkey. <sub>[You'd need these mods for it to work: [code injector](https://greasyfork.org/en/scripts/433861-code-injector-bonk-io), [bonkLIB](https://greasyfork.org/en/scripts/508104-bonklib), and [bonk host](https://greasyfork.org/en/scripts/435169-bonk-host)</sub>
